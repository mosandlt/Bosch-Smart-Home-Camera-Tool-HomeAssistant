 ...
 */
const CARD_VERSION = "13.3.0+0.0.0.1";
...
class BoschCameraCard extends HTMLElement {
  ...
  _updateFullscreenButtonState() {
    ...
    if (!btn) return;
    const wrapper = this.shadowRoot?.getElementById("img-wrapper");
    const nativeFs = !!(document.fullscreenElement === wrapper || document.webkitFullscreenElement === wrapper || document.mozFullScreenElement === wrapper || document.msFullscreenElement === wrapper);
