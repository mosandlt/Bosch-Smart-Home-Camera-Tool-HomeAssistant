...
Latest: **v13.4.2** — see the GitHub release page for full notes:
[**v13.4.2 release notes →**](https://github.com/mosandlt/Bosch-Smart-Home-Camera-Tool-HomeAssistant/releases/tag/v13.4.2)
...
|---|---|---|
| 🏆 **Home Assistant Integration** (this repo) | [Bosch-Smart-Home-Camera-Tool-HomeAssistant](https://github.com/mosandlt/Bosch-Smart-Home-Camera-Tool-HomeAssistant) | **v13.4.2** · HA Quality Scale **Platinum** · production-ready |
