...
| Version | Changes |
|---------|---------|
| **v8.0.2** | **Separate light controls.** Front light and wallwasher are now independent switches (disabled by default — enable in Settings → Entities). Front light intensity slider (0–100%). Lovelace card v2.6.0 with light controls in Erweitert accordion. Individual light components preserve each other's state when toggled. |
