...
Latest: **v12.4.5** — see the GitHub release page for full notes:
[**v12.4.5 release notes →**](https://github.com/mosandlt/Bosch-Smart-Home-Camera-Tool-HomeAssistant/releases/tag/v12.4.5)
...
|---|---|---|
| 🏆 **Home Assistant Integration** (this repo) | [Bosch-Smart-Home-Camera-Tool-HomeAssistant](https://github.com/mosandlt/Bosch-Smart-Home-Camera-Tool-HomeAssistant) | **v12.4.5** · HA Quality Scale **Platinum** · production-ready |
