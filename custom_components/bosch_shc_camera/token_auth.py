...
class TokenAuthCoordinatorMixin:
    ...
    async def _refresh_token_locked(
        ...
        from . import ir as ir  # type: ignore[attr-defined]
        from .config_flow import AuthServerOutageError, RefreshTokenInvalidError
        ...
        # other caller of `ensure_valid_token` (including all 401-recovery
    ...
    def schedule_token_refresh(self: Any) -> None:
        ...
        try:
            ...
            _LOGGER.debug("schedule_token_refresh: cannot parse token expiry: %s", err)
    ...
    async def _proactive_refresh(self: Any) -> None:
        ...
        try:
            ...
            # ensure_valid_token calls schedule_token_refresh on success,
